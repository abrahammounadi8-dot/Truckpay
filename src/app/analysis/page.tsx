  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <p className="text-[0.72rem] font-semibold tracking-[0.2em] text-muted-foreground uppercase">
        My TruckPay · latest three slips
      </p>
      ...
      <p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground">
        ...
        extracted. Missing periods are warned. Duplicates are rejected. Changes versus earlier slips keep
        unexplained remainder unexplained. This is not an accusation of the employer.
      </p>
      <div className="mt-8">
        <AnalysisBoard />
      </div>
