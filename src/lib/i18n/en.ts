...
export const en: Messages = {
  ...
  footer: {
    tagline:
      "MyTruckPay understands your payslip, so you don’t have to. Ireland first. Private payroll and company intelligence grow together — never invented reviews.",
    myTruckPay: "Payslips",
  ...
  home: {
    kicker: "Ireland · MyTruckPay + Companies",
    headline: "MyTruckPay understands your payslip, so you don’t have to.",
    ...
    step2Title: "MyTruckPay Companies",
  ...
  access: {
    ...
    howItWorks: "How MyTruckPay works",
  ...
  stub: {
    ...
    noInvent: "MyTruckPay does not invent reviews or take-home figures. The first Irish driver to file a real wage slip opens this board.",
  ...
  payslips: {
    ...
    towardVerified: "{have} of {need} unique slips toward MyTruckPay Verified Analysis. Duplicates are rejected. One slip is not one week.",
  ...
  form: {
    ...
    title: "Add a payslip",
    lead: "Drop the PDF or photo at the top of the form. Then check the figures. Do not type a PPSN, licence or employee number. MyTruckPay does not assume one slip is one working week.",
    putHere: "Put your payslip here",
    putHereHelp: "Drop a PDF or a photo, or choose a file. MyTruckPay reads it and discards it — it is not stored.",
    ...
    afterFile: "After the file, check the boxes below. Leave a box blank if it is not printed — MyTruckPay will store null and will not guess. MyTruckPay Verified Analysis needs your latest three unique payslips. A payslip is not assumed to be one week.",
    ...
    deductionHelp: "Copy the label exactly as printed. Unknown labels stay unknown and are flagged for review. MyTruckPay will not mark a deduction as illegal.",
  ...
  detail: {
    ...
    hoursHelp: "Figures below are from the document unless marked derived. Blank fields stay blank — MyTruckPay does not guess.",
    ...
    anomalyLead: "Confirmed only with enough evidence. Otherwise MyTruckPay uses possible anomaly, needs review, or insufficient data. Nothing here is an accusation.",
    noAnomalies: "No anomaly flags on the figures you entered.",
    checks: "Checks",
    checksLead: "Every note is labelled Fact, Inference, or Unknown, with the figures it used. MyTruckPay does not accuse an employer of wrongdoing from an anomaly.",
  ...
  analysis: {
    kicker: "MyTruckPay · latest three slips",
  ...
  privacy: {
    ...
    title: "Privacy",
    p1: "MyTruckPay splits identity from payroll. You are identified by a random UUID on this device — not a PPSN, driving licence, or employee number.",
    ...
    l3: "Extracted payroll — figures you type, private to MyTruckPay.",
    l4: "Normalized payroll — categories and weekly equivalents for your analysis.",
    l5: "Aggregated analytical data — medians and sample sizes for MyTruckPay Companies, with no driver identity. This is pseudonymised aggregation, not a claim that the dataset is anonymous.",
